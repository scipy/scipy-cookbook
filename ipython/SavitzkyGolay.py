...
# ------
# 
# <![](files/SavitzkyGolay_attachments/cd_spec.png>
)# 
...
# <![](files/SavitzkyGolay_attachments/Original.pdf> Original data <![](files/SavitzkyGolay_attachments/Original+noise.pdf>
)# Original data + noise <![](files/SavitzkyGolay_attachments/Original+noise+filtered.pdf> (Original
)# data + noise) filtered
# 
