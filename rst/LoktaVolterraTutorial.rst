...
.. image:: LoktaVolterraTutorial_attachments/tutorial_lokta-voltera_v4.py .
...
point <http://en.wikipedia.org/wiki/Saddle_point>`__.
...
.. code-block:: python
    ...
    # They are imaginary numbers. The fox and rabbit populations are periodic as fol
    #lows from further
...
.. code-block:: python
    ...
    X0 = array([10, 5])                     # initials conditions: 10 rabbits and 5 
    foxes
...
.. image:: LoktaVolterraTutorial_attachments/rabbits_and_foxes_1v2.png
...
`ShowColormaps <http://www.scipy.org/Cookbook/Matplotlib/Show_colormaps>`__
...
.. code-block:: python
    ...
    values  = linspace(0.3, 0.9, 5)                          # position of X0 betwee
    n X_f0 and X_f1
    vcolors = p.cm.autumn_r(linspace(0.3, 1., len(values)))  # colors for each traje
    ctory
    ...
    DX1, DY1 = dX_dt([X1, Y1])                      # compute growth rate on the gri
    dt
...
.. image:: LoktaVolterraTutorial_attachments/rabbits_and_foxes_2v3.png
...
.. code-block:: python
    ...
    for v in values:
        ...
        I = IF(X.T)                                 # compute IF along the trajector
    y
        I_mean = I.mean()
...
.. image:: LoktaVolterraTutorial_attachments/rabbits_and_foxes_3v2.png
